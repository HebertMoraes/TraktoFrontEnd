...
describe('LoginFrameComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      providers: [HttpClient, HttpHandler, AuthenticationService], 
  ...
  it('submitAuthentication', async () => {
    const SignInSpy = jest.spyOn(component.authService, 'signInWithEmailPassword');
    SignInSpy.mockReturnValue(of(statusOkMock));
    await expect(lastValueFrom(component.authService.signInWithEmailPassword("teste@gmail.com", "senhaBacana")))
